...
class PluginRubberSpringPage extends StatefulWidget {
  PluginRubberSpringPage({Key key}) : super(key: key);

  @override
  _PluginRubberSpringPage createState() => _PluginRubberSpringPage();
}

class _PluginRubberSpringPage extends State<PluginRubberSpringPage>
