...
class WidgetsAllInListViewNotificationListener extends StatefulWidget {
  @override
  _WidgetsAllInListViewNotificationListener createState() =>
      new _WidgetsAllInListViewNotificationListener();
}

class _WidgetsAllInListViewNotificationListener
    extends State<WidgetsAllInListViewNotificationListener> {
      ...
      body: Scrollbar(
        ...
        child: NotificationListener<ScrollNotification>(
          onNotification: (ScrollNotification notification) {
            /// metrics属性，它的类型是ScrollMetrics，该属性包含当前ViewPort及滚动位置等信息：
